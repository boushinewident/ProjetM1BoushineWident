...
to mettreAJourStrategieTitForTat
  ask turtles[
    ...
    ask (turtles-on neighbors4) [
      if strategie = 0 
      [ask turtle numAgent[set numCooperateursVoisinsTourPrecedent (numCooperateursVoisinsTourPrecedent + 1)]]
    ]
    ifelse ((random-float 1) > (numCooperateursVoisinsTourPrecedent / 4))
    [set StratTemp 1]
    [set StratTemp 0]   
  ]
  ask turtles[
...
to CalculerMoyennes
  ...
  set MoyennePayOffCooperateurs TotalPayOffCooperateurs / nbCooperateurs
  set MoyennePayOffDefecteurs TotalPayOffDefecteurs / nbDefecteurs
